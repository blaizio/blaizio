...
/// <summary>Which way a <see cref="BzDataTable{TItem}"/> column is sorted.</summary>
...
/// <summary>
/// The active sort of a <see cref="BzDataTable{TItem}"/>: which column (by <paramref name="ColumnKey"/>)
