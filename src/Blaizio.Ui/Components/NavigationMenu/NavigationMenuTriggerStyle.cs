...
public static class NavigationMenuTriggerStyle
{
    ...
    public const string Classes =
        "group inline-flex h-9 w-max items-center justify-center rounded-md border border-transparent bg-background px-4 py-2 text-sm font-medium " +
        "transition-[color,box-shadow] outline-none hover:bg-accent hover:text-accent-foreground " +
        "focus:bg-accent focus:text-accent-foreground focus-visible:ring-ring/50 focus-visible:ring-2 focus-visible:border-ring " +
