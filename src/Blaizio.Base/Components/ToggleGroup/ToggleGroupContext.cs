...
/// </summary>
/// <param name="SelectionMode">The selection mode (single / multiple).</param>
...
public sealed record ToggleGroupContext(
    SelectionMode SelectionMode, IReadOnlyList<string> Values, bool Disabled, EventCallback<string> Toggle)
{
