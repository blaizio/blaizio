...
/// </para>
/// </remarks>
public abstract class BlazeComponentBase : ComponentBase
{
    /// <summary>
    /// The ambient reading direction supplied by an ancestor <see cref="BlazeDirectionProvider"/>.
    /// Prefer <see cref="ResolvedDirection"/> when reading.
    /// </summary>
    [CascadingParameter(Name = BlazeDirectionProvider.CascadeName)]
