...
public static class BlazeoBaseServiceCollectionExtensions
{
    ...
    /// <see cref="BzDialogProvider"/> and the imperative dialog API, the scoped <see cref="IToastStore"/>
    /// behind <see cref="BzToastProvider"/> and the imperative toast API, and the scoped
