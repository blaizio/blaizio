...
public class CheckboxRenderTests : TestContext
{
    ...
    {
        var cut = RenderComponent<BzCheckbox>();
    ...
    {
        var cut = RenderComponent<BzCheckbox>(p => p.Add(x => x.DefaultChecked, CheckedState.Checked));
    ...
    {
        var cut = RenderComponent<BzCheckbox>(p => p.Add(x => x.DefaultChecked, CheckedState.Indeterminate));
    ...
    {
        var cut = RenderComponent<BzCheckbox>(p => p.Add(x => x.Disabled, true));
    ...
    public void Controlled_does_not_self_update_but_raises_change()
    {
        ...
        var cut = RenderComponent<BzCheckbox>(p => p
    ...
    {
        var cut = RenderComponent<BzCheckbox>(p => p.AddChildContent<BzCheckboxIndicator>());
    ...
    public void Indicator_renders_when_indeterminate()
    {
        var cut = RenderComponent<BzCheckbox>(p => p
            ...
            .AddChildContent<BzCheckboxIndicator>());
