...
public class HoverCardRenderTests : TestContext
{
    ...
    {
        builder.OpenComponent<BaseHoverCardTrigger>(0);
        builder.AddComponentParameter(1, nameof(BaseHoverCardTrigger.ChildContent),
            (RenderFragment)(t => t.AddContent(0, "Trigger")));
        builder.CloseComponent();
        builder.OpenComponent<BaseHoverCardContent>(2);
        builder.AddComponentParameter(3, nameof(BaseHoverCardContent.ChildContent),
